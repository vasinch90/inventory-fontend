          ...
          <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
            ...
            <div class="w-full">
              ...
              <form @submit.prevent="onSubmit">
                ...
                <input class="w-full px-3 py-2 leading-tight text-gray-700 border rounded shadow appearance-none" id="email" type="text" autocomplete="email" v-model="email">
                ...
                <input class="w-full px-3 py-2 leading-tight text-gray-700 border rounded shadow appearance-none" id="password" type="password" autocomplete="current-password" v-model="password">
                ...
                <input type="submit"
                    class="block w-full px-4 py-2 mt-4 text-sm font-medium leading-5 text-center text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg cursor-pointer active:bg-purple-600 hover:bg-purple-700" value="เข้าสู่ระบบ" @click="submitForm">
              </form>
  ...
  validations(){
    return {
      email: {
        ...
        email: helpers.withMessage('รูปแบบอีเมบ์ไม่ถูกต้อง', email)
      },
      password: {
        ...
        minLength: helpers.withMessage(
          ({
            $params
          }) => 'รหัสผ่านต้องไม่น้อยกว่า ' + $params.min + ' อักษร', minLength(4)
        )
      }
    }
  }
